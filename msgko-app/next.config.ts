        ...
        headers: [
          ...
          { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.ytimg.com https://*.cdninstagram.com https://image.nttgame.com https://*.supabase.co",
              "media-src 'self' blob:",
              "frame-src https://www.youtube.com https://www.instagram.com",
              "connect-src 'self' https://*.supabase.co https://www.googleapis.com https://www.instagram.com",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
            ].join('; '),
