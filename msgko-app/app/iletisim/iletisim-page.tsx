  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--void)' }}>
      <div className="fixed inset-0 pointer-events-none" style={{
        background: `
          radial-gradient(ellipse 55% 45% at 15% 25%, rgba(212,168,50,0.08) 0%, transparent 60%),
          radial-gradient(ellipse 45% 55% at 85% 75%, rgba(58,74,107,0.06) 0%, transparent 55%)
        `
      }} />
      <div className="fixed top-0 left-0 right-0 h-px pointer-events-none z-10"
        style={{ background: 'linear-gradient(90deg, transparent, rgba(212,168,50,0.7), rgba(240,192,80,0.5), transparent)' }}
      />
      ...
      >
        ...
        <div className="absolute left-1/2 -translate-x-1/2 flex flex-col items-center">
          <p className="text-[0.62rem] font-bold tracking-[0.3em] uppercase mb-0.5"
            style={{ color: 'rgba(212,168,50,0.7)' }}>MSGKO.NET</p>
        ...
        <div className="w-full max-w-[400px] flex flex-col gap-4">
          ...
          <motion.a
            ...
            onMouseEnter={e => {
              ...
              e.currentTarget.style.background = 'rgba(212,168,50,0.06)'
              e.currentTarget.style.boxShadow = '0 0 24px rgba(212,168,50,0.1)'
            }}
            onMouseLeave={e => {
              e.currentTarget.style.borderColor = 'rgba(255,255,255,0.06)'
              e.currentTarget.style.background = 'rgba(255,255,255,0.02)'
          ...
          >
            <div className="w-11 h-11 flex items-center justify-center flex-shrink-0"
              style={{ background: 'rgba(212,168,50,0.12)', border: '1px solid rgba(212,168,50,0.25)', borderRadius: '10px' }}>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.35 }}
            ...
            <div className="w-1 h-1 rounded-full" style={{ background: 'rgba(212,168,50,0.4)' }} />
            <p className="text-[0.6rem] tracking-[0.1em] uppercase" style={{ color: 'rgba(212,168,50,0.4)' }}>MSGKO.NET</p>
            <div className="w-1 h-1 rounded-full" style={{ background: 'rgba(212,168,50,0.4)' }} />
          </motion.div>
        </div>
      </div>
