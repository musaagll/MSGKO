  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--void)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        background: 'radial-gradient(ellipse 55% 45% at 15% 25%, rgba(200,16,46,0.08) 0%, transparent 55%)',
      }} />
            ...
            {activeList.map((v, i) => (
              ...
              >
                ...
                <div style={{ position: 'relative', aspectRatio: '16/9', overflow: 'hidden', background: 'var(--abyss)' }}>
                  ...
                  {/* Play */}
                  <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', opacity: 0, transition: 'opacity 0.3s', background: 'rgba(200,16,46,0.15)' }}
                    className="group-hover:opacity-100">
                    <div style={{ width: 52, height: 52, background: 'var(--crimson)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 0 32px rgba(200,16,46,0.6)' }}>
