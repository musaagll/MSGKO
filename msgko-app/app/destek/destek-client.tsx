  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--void)' }}>
      ...
      <div className="fixed inset-0 pointer-events-none" style={{
        background: `
          radial-gradient(ellipse 55% 45% at 15% 25%, rgba(200,150,12,0.08) 0%, transparent 65%),
          radial-gradient(ellipse 45% 55% at 85% 75%, rgba(160,120,40,0.06) 0%, transparent 60%),
      ...
      >
        ...
        <div className="absolute left-1/2 -translate-x-1/2 flex flex-col items-center">
          <p className="text-[0.62rem] font-bold tracking-[0.3em] uppercase mb-0.5"
            style={{ color: 'rgba(200,150,12,0.7)' }}>
            MSGKO.NET
          </p>
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 blur-2xl opacity-40 scale-150"
                style={{ background: 'radial-gradient(circle, rgba(160,120,40,0.6), rgba(200,150,12,0.4))' }}
              />
              <motion.div
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(200,150,12,0.15), rgba(160,120,40,0.15))',
            ...
            <div className="w-16 h-px" style={{ background: 'linear-gradient(90deg, transparent, rgba(200,150,12,0.5), transparent)' }} />
          </motion.div>
