  ...
  return (
    <footer style={{ position: 'relative', background: 'var(--abyss)', overflow: 'hidden' }} aria-label="Site footer">
      ...
      <div style={{
        ...
        background: 'radial-gradient(ellipse 60% 50% at 0% 100%, rgba(200,16,46,0.05) 0%, transparent 55%)',
      }} />
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
              <Image src="/logo.png" alt="MSGKO" width={48} height={48}
                style={{ mixBlendMode: 'screen', filter: 'brightness(1.3) drop-shadow(0 0 8px rgba(200,16,46,0.4))' }} />
              <div>
