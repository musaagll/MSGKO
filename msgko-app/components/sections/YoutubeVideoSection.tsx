  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'radial-gradient(ellipse 70% 55% at 100% 0%, rgba(212,168,50,0.07) 0%, transparent 55%)',
      }} />
            ...
            <div style={{ position: 'relative', aspectRatio: '16/9', overflow: 'hidden', background: 'var(--void)' }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  boxShadow: '0 0 40px rgba(212,168,50,0.6)',
                }}>
            ...
            {secondary.map((video, i) => (
              ...
              >
                ...
                <div style={{ position: 'relative', width: 112, flexShrink: 0, aspectRatio: '16/9', overflow: 'hidden', background: 'var(--void)' }}>
                  ...
                  <div style={{ position: 'absolute', inset: 0, opacity: 0, transition: 'opacity 0.25s', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(212,168,50,0.3)' }}
                    className="group-hover:opacity-100">
