  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'radial-gradient(ellipse 70% 55% at 100% 0%, rgba(201,168,76,0.05) 0%, transparent 55%)',
      }} />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(1,1fr)', gap: 16 }}
          ...
          >
            ...
            <div style={{ position: 'relative', aspectRatio: '16/9', overflow: 'hidden', background: 'var(--void)' }}>
              {featured.thumbnail && (
                <Image src={featured.thumbnail} alt={featured.title} fill sizes="(max-width: 1024px) 100vw, 60vw"
                  className="object-cover transition-transform duration-700 group-hover:scale-[1.05]" />
              )}
              <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(7,8,13,0.9) 0%, rgba(7,8,13,0.2) 40%, transparent 100%)' }} />
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <Play size={24} fill="#07080d" color="#07080d" style={{ marginLeft: 3 }} />
                </div>
              </div>
              ...
              {/* Badge */}
              <div style={{ position: 'absolute', top: 12, left: 12 }} className="badge badge-crimson">
                En Son Video
              </div>
            </div>
            ...
            <div style={{ padding: '16px 20px 20px' }}>
              <h3 style={{
                ...
                color: 'var(--platinum)', marginBottom: 10, transition: 'color 0.2s',
              }}>
                {featured.title}
              </h3>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: '0.65rem', color: 'var(--iron)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                  <Image src="/logo.png" alt="MSGKO" width={12} height={12} style={{ mixBlendMode: 'screen', opacity: 0.7 }} />
                  <span>MSGKO</span>
                </div>
                <span>·</span>
                <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                  <Eye size={9} /><span>{formatViews(featured.views)}</span>
                </div>
                <span>·</span>
            ...
            <div style={{
              ...
              background: 'linear-gradient(90deg, var(--crimson), var(--crimson-bright), transparent)',
            ...
            {secondary.map((video, i) => (
              ...
              >
                <div style={{ position: 'relative', width: 112, flexShrink: 0, aspectRatio: '16/9', overflow: 'hidden', background: 'var(--void)' }}>
                  ...
                  <div style={{ position: 'absolute', inset: 0, opacity: 0, transition: 'opacity 0.25s', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(201,168,76,0.25)' }}
                    className="group-hover:opacity-100">
                    <Play size={16} fill="#07080d" color="#07080d" style={{ marginLeft: 2 }} />
                  </div>
                  {video.durationFormatted && (
                    <div style={{ position: 'absolute', bottom: 4, right: 4, padding: '2px 5px', background: 'rgba(7,8,13,0.95)' }}>
