...
interface OkcuModalProps {
  isOpen: boolean
  onClose: () => void
}

export function OkcuModal({ isOpen, onClose }: OkcuModalProps) {
  useEffect(() => {
        ...
        <>
          ...
          >
            ...
            <div className="px-10 py-12 flex flex-col items-center text-center">
              <div className="w-16 h-16 border border-white/[0.08] bg-[#2A2A2A] flex items-center justify-center text-2xl mb-6">
                🏹
              </div>
              ...
              <p className="text-[#999999] text-[0.82rem] leading-relaxed">
                Okçu eğitim videoları hazırlanıyor. Kısa sürede burada olacak.
              </p>
